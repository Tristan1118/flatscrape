...
class SearchParameters():
    ...
    def parse_aws_event(self, awsEvent):
        ...
        self.moveInUpper = parse_german_date(awsEvent.get("moveInLower", "01.01.3000"))
        self.moveOutLower = parse_german_date(awsEvent.get("moveInLower", "01.01.1900"))
        self.moveOutUpper = parse_german_date(awsEvent.get("moveInLower", "01.01.3000"))
